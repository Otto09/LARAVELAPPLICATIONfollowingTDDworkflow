...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/NewOwnerModal.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/NewOwnerModal.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _AnimalboardForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AnimalboardForm */ "./resources/js/components/AnimalboardForm.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      form: new _AnimalboardForm__WEBPACK_IMPORTED_MODULE_1__["default"]({
        owner: '',
        animal: '',
        specifics: [{
          body: ''
  ...
  methods: {
    addSpecific: function addSpecific() {
      this.form.specifics.push({
        body: ''
      });
    },
    submit: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.form.submit('/owners').then(function (response) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/NewOwnerModal.vue?vue&type=template&id=84d2c7c2&":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/NewOwnerModal.vue?vue&type=template&id=84d2c7c2& ***!
  \****************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
          ...
          _c("div", { staticClass: "flex " }, [
            _c("div", { staticClass: "flex-1 mr-4" }, [
              _c("div", { staticClass: "mb-4" }, [
                _c(
                  "label",
                  {
                    staticClass: "text-normal block mb-2",
                    attrs: { for: "owner" }
                  },
                  [_vm._v("Owner\n\n\t  \t\t\t\t\t\t")]
                ),
                ...
                _c("input", {
                  ...
                  staticClass: "border py-1 px-2 block w-full rounded",
                  class: _vm.form.errors.owner
                    ? "border-error"
                    : "border-muted-light",
                ...
                _vm._v(" "),
                _vm.form.errors.owner
                  ? _c("span", {
                      staticClass: "text-xs italic text-error",
                      domProps: {
                        textContent: _vm._s(_vm.form.errors.owner[0])
                      }
                    })
                  : _vm._e()
              ]),
              ...
              _c("div", { staticClass: "mb-4" }, [
                ...
                _c("input", {
                  ...
                  staticClass:
                    " border py-1 px-2 block w-full \n\n\t  \t\t\t\t\t\t\trounded 'border-muted-light'",
                  class: _vm.form.errors.animal
                    ? "border-error"
                    : "border-muted-light",
                  attrs: { type: "text", id: "animal" },
                  domProps: { value: _vm.form.animal },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.form, "animal", $event.target.value)
                    }
                  }
                }),
                _vm._v(" "),
                _vm.form.errors.animal
                  ? _c("span", {
                      staticClass: "text-xs italic text-error",
                      domProps: {
                        textContent: _vm._s(_vm.form.errors.animal[0])
                      }
                    })
                  : _vm._e()
              ])
            ...
            _c("div", { staticClass: "flex-1 ml-4" }, [
              _c(
                ...
                { staticClass: "mb-4" },
                [
                  _c("label", { staticClass: "text-normal block mb-2" }, [
                    _vm._v(
                      "\n\t  \t\t\t\t\t\n\t  \t\t\t\t\t\tNeed Some Specifics ?\n\n\t  \t\t\t\t\t"
                    )
                  ]),
                  _vm._v(" "),
                  _vm._l(_vm.form.specifics, function(specific) {
                    return _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: specific.body,
                          expression: "specific.body"
                        }
                      ],
                      staticClass:
                        " border border-muted-light \n\n\t  \t\t\t\t\t\t\tmb-2 py-1 px-2 block w-full rounded",
                      attrs: { type: "text", placeholder: "Specific 1" },
                      domProps: { value: specific.body },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(specific, "body", $event.target.value)
                        }
                      }
                    })
                  })
              ...
              _c(
                ...
                {
                  staticClass:
                    "button is-link rounded-full px-3 \n\n\t  \t\t\t\t\ttext-default",
                  attrs: { type: "button" },
                  on: { click: _vm.addSpecific }
                },
                [_vm._v("+\n\n\t  \t\t\t\t")]
              ),
              _vm._v(" "),
              _c("span", [_vm._v("Add New Specific Field")])
            ])
          ]),
          _vm._v(" "),
          _c("footer", { staticClass: "flex justify-end" }, [
            _c(
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.$modal.hide("new-owner")
                  }
                }
              },
              [_vm._v("Cancel")]
            ...
            _vm._v(" "),
            _c("button", { staticClass: "button" }, [_vm._v("Create Owner")])
          ])
        ]
      )
    ]
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.themes, function(color, theme) {
      return _c("button", {
        staticClass:
          "rounded-full w-4 h-4 \n\n        bg-default border mr-2 focus:outline-none",
...
Vue.component('new-owner-modal', __webpack_require__(/*! ./components/NewOwnerModal.vue */ "./resources/js/components/NewOwnerModal.vue")["default"]);
...
/***/ "./resources/js/components/AnimalboardForm.js":
/*!****************************************************!*\
  !*** ./resources/js/components/AnimalboardForm.js ***!
  \****************************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function () {
  function AnimalboardForm(data) {
    _classCallCheck(this, AnimalboardForm);

    this.originalData = {}; // Object.assign(this.originalData, data);

    this.originalData = JSON.parse(JSON.stringify(data)); // form.owner
    // form.animal
  ...
  return AnimalboardForm;
}();

/* harmony default export */ __webpack_exports__["default"] = (AnimalboardForm);
...
/***/ "./resources/js/components/NewOwnerModal.vue":
/*!***************************************************!*\
  !*** ./resources/js/components/NewOwnerModal.vue ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _NewOwnerModal_vue_vue_type_template_id_84d2c7c2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./NewOwnerModal.vue?vue&type=template&id=84d2c7c2& */ "./resources/js/components/NewOwnerModal.vue?vue&type=template&id=84d2c7c2&");
/* harmony import */ var _NewOwnerModal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./NewOwnerModal.vue?vue&type=script&lang=js& */ "./resources/js/components/NewOwnerModal.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _NewOwnerModal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _NewOwnerModal_vue_vue_type_template_id_84d2c7c2___WEBPACK_IMPORTED_MODULE_0__["render"],
  _NewOwnerModal_vue_vue_type_template_id_84d2c7c2___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/NewOwnerModal.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/NewOwnerModal.vue?vue&type=script&lang=js&":
/*!****************************************************************************!*\
  !*** ./resources/js/components/NewOwnerModal.vue?vue&type=script&lang=js& ***!
  \****************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NewOwnerModal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./NewOwnerModal.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/NewOwnerModal.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_NewOwnerModal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/NewOwnerModal.vue?vue&type=template&id=84d2c7c2&":
/*!**********************************************************************************!*\
  !*** ./resources/js/components/NewOwnerModal.vue?vue&type=template&id=84d2c7c2& ***!
  \**********************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_NewOwnerModal_vue_vue_type_template_id_84d2c7c2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./NewOwnerModal.vue?vue&type=template&id=84d2c7c2& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/NewOwnerModal.vue?vue&type=template&id=84d2c7c2&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_NewOwnerModal_vue_vue_type_template_id_84d2c7c2___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_NewOwnerModal_vue_vue_type_template_id_84d2c7c2___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
__webpack_require__(/*! D:\laravelprojects\animalboard\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\laravelprojects\animalboard\resources\sass\app.scss */"./resources/sass/app.scss");
